...
function Group118() {
  return (
    <div className="[word-break:break-word] absolute contents left-[calc(50%+97px)] not-italic top-[5928px]">
      <p className="font-poppins font-normal absolute leading-[1.8] left-[calc(50%+97px)] text-[#696984] text-[22px] top-[6076px] tracking-[0.44px] w-[596px]">Easily launch live assignments, quizzes, and tests. Student results are automatically entered in the online gradebook.</p>
      <p className="font-nunito font-bold absolute leading-[0] left-[calc(50%+97px)] text-[#2f327d] text-[40px] top-[5928px] w-[347px]" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>
        <span className="font-poppins font-semibold leading-[1.6]">{`Assessments, `}</span>
        <span className="font-poppins font-semibold leading-[1.6] text-[#f48c06]">Quizzes</span>
        <span className="font-poppins font-semibold leading-[1.6]">, Tests</span>
      </p>
    </div>
  );
}
...
function MaskGroup7() {
  return (
    <div className="absolute contents left-[calc(8.33%+149.84px)] top-[6134.99px]" data-name="Mask Group">
...
function MaskGroup8() {
  return (
    <div className="absolute contents left-[calc(8.33%+112.48px)] top-[6104.33px]" data-name="Mask Group">
...
function Group1() {
  return (
    <div className="absolute inset-[6.86%_0]" data-name="Group">
...
function Group() {
  return (
    <div className="absolute contents inset-[6.86%_0]" data-name="Group">
      <Group1 />
    </div>
  );
}
